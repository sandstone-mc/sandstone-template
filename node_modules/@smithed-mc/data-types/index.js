...
export const PackDownloadOptionsSchema = Type.Partial(Type.Object({
 ...
 * @returns
 */
export function BundleUpdater(bundle) {
    if (bundle.schemaVersion == "v2")
        return bundle;
    return {
        schemaVersion: 'v2',
        owner: bundle.owner,
...
export const UserDataSchema = Type.Object({
    ...
    role: Type.Readonly(Type.Union([Type.Literal("member"), Type.Literal("admin")])),
});
export var SortOptions;
(function (SortOptions) {
    SortOptions["Trending"] = "trending";
    SortOptions["Downloads"] = "downloads";
    SortOptions["Alphabetically"] = "alphabetically";
...
export var HTTPResponses;
(function (HTTPResponses) {
    HTTPResponses[HTTPResponses["OK"] = 200] = "OK";
    HTTPResponses[HTTPResponses["CREATED"] = 201] = "CREATED";
    HTTPResponses[HTTPResponses["BAD_REQUEST"] = 400] = "BAD_REQUEST";
    HTTPResponses[HTTPResponses["UNAUTHORIZED"] = 401] = "UNAUTHORIZED";
    HTTPResponses[HTTPResponses["FORBIDDEN"] = 403] = "FORBIDDEN";
    HTTPResponses[HTTPResponses["NOT_FOUND"] = 404] = "NOT_FOUND";
    HTTPResponses[HTTPResponses["CONFLICT"] = 409] = "CONFLICT";
    HTTPResponses[HTTPResponses["SERVER_ERROR"] = 500] = "SERVER_ERROR";
