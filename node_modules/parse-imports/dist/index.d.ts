 ...
 * - 'package' otherwise
 */
type ModuleSpecifierType = `invalid` | `absolute` | `relative` | `builtin` | `package` | `unknown`;
 ...
 * the imports in `code`.
 */
declare const parseImports: (code: string, options?: Options) => Promise<Iterable<Import>>;
 ...
 */
declare const parseImportsSync: (code: string, options?: Options) => Iterable<Import>;
//#endregion
export { Import, ModuleSpecifierType, Options, parseImports, parseImportsSync, wasmLoadPromise };