...
import type { MultipleEntitiesArgument } from '../../../arguments/index.js';
...
export declare class EffectCommandNode extends CommandNode {
    command: "effect";
}
export declare class EffectCommand<MACRO extends boolean> extends CommandArguments {
    protected NodeType: typeof EffectCommandNode;
    /**
     ...
     * ```
     */
    give: (targets: Macroable<MultipleEntitiesArgument<MACRO>, MACRO>, effect: Macroable<Registry["minecraft:mob_effect"], MACRO>, seconds?: number | "infinite", amplifier?: number, hideParticles?: boolean) => /*                     */FinalCommandOutput;
    /**
     ...
     * ```
     */
    clear: (targets?: Macroable<MultipleEntitiesArgument<MACRO>, MACRO>, effect?: Macroable<Registry["minecraft:mob_effect"], MACRO>) => /*                     */FinalCommandOutput;
}
