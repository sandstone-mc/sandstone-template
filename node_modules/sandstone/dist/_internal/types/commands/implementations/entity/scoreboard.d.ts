...
import type { DISPLAY_SLOTS, FormattingTags, JSONTextComponent, MultipleEntitiesArgument, OBJECTIVE_CRITERIA, ObjectiveArgument, OPERATORS } from '../../../arguments/index.js';
...
export declare class ScoreboardCommandNode extends CommandNode {
    command: "scoreboard";
}
export declare class ScoreboardObjectivesModifyCommand<MACRO extends boolean> extends CommandArguments {
    /**
     ...
     * ```
     */
    displayname: (displayName?: Macroable<JSONTextComponent, MACRO>) => /*                     */FinalCommandOutput;
    /**
     ...
     * ```
     */
    rendertype: (display: Macroable<"hearts" | "integer", MACRO>) => /*                     */FinalCommandOutput;
}
export declare class ScoreboardCommand<MACRO extends boolean> extends CommandArguments {
    protected NodeType: typeof ScoreboardCommandNode;
    /**
    ...
    objectives: {
         ...
         * ```
         */
        add: (objective: Macroable<ObjectiveArgument, MACRO>, criteria: Macroable<LiteralUnion<OBJECTIVE_CRITERIA>, MACRO>, displayName?: Macroable<JSONTextComponent, MACRO>) => /*                     */FinalCommandOutput;
        /**
         ...
         * ```
         */
        remove: (objective: Macroable<ObjectiveArgument, MACRO>) => /*                     */FinalCommandOutput;
        /**
         ...
         * ```
         */
        setdisplay: (slot: Macroable<DISPLAY_SLOTS, MACRO>, objective?: Macroable<ObjectiveArgument, MACRO>) => /*                     */FinalCommandOutput;
        /**
         ...
         * ```
         */
        modify: (objective: Macroable<ObjectiveArgument, MACRO>) => ScoreboardObjectivesModifyCommand<boolean>;
    };
    /**
    ...
    players: {
         ...
         * ```
         */
        readonly list: (target?: Macroable<MultipleEntitiesArgument<MACRO>, MACRO>) => /*                     */FinalCommandOutput;
        /**
         ...
         * ```
         */
        readonly get: (...args: [target: Macroable<MultipleEntitiesArgument<MACRO> | number, MACRO>, objective: Macroable<ObjectiveArgument, MACRO>] | [target: Macroable<Score, MACRO>]) => /*                     */FinalCommandOutput;
        /**
         ...
         * ```
         */
        readonly set: (...args: [..._: [target: Macroable<MultipleEntitiesArgument<MACRO> | number, MACRO>, objective: Macroable<ObjectiveArgument, MACRO>] | [target: Macroable<Score, MACRO>], score: Macroable<number, MACRO>]) => /*                     */FinalCommandOutput;
        /**
         ...
         * ```
         */
        readonly add: (...args: [..._: [target: Macroable<MultipleEntitiesArgument<MACRO> | number, MACRO>, objective: Macroable<ObjectiveArgument, MACRO>] | [target: Macroable<Score, MACRO>], score: Macroable<number, MACRO>]) => /*                     */FinalCommandOutput;
        /**
         ...
         * ```
         */
        readonly remove: (...args: [..._: [target: Macroable<MultipleEntitiesArgument<MACRO> | number, MACRO>, objective: Macroable<ObjectiveArgument, MACRO>] | [target: Macroable<Score, MACRO>], score: Macroable<number, MACRO>]) => /*                     */FinalCommandOutput;
        /**
         ...
         * ```
         */
        readonly reset: (...args: [target: Macroable<MultipleEntitiesArgument<MACRO> | number, MACRO>, objective: Macroable<ObjectiveArgument, MACRO>] | [target: Macroable<Score, MACRO>]) => /*                     */FinalCommandOutput;
        /**
         ...
         * ```
         */
        readonly enable: (...args: [target: Macroable<MultipleEntitiesArgument<MACRO> | number, MACRO>, objective: Macroable<ObjectiveArgument, MACRO>] | [target: Macroable<Score, MACRO>]) => /*                     */FinalCommandOutput;
        /**
         ...
         * ```
         */
        readonly operation: (...args: [...target: [target: Macroable<MultipleEntitiesArgument<MACRO> | number, MACRO>, targetObjective: Macroable<ObjectiveArgument, MACRO>] | [targetScore: Macroable<Score, MACRO>], operation: OPERATORS, ...source: [source: Macroable<MultipleEntitiesArgument<MACRO> | number, MACRO>, sourceObjective: Macroable<ObjectiveArgument, MACRO>] | [sourceScore: Macroable<Score, MACRO>]]) => /*                     */FinalCommandOutput;
        /**
        ...
        readonly display: {
             ...
             * ```
             */
            readonly name: (...args: [...target: [target: Macroable<MultipleEntitiesArgument<MACRO> | number, MACRO>, targetObjective: Macroable<ObjectiveArgument, MACRO>] | [targetScore: Macroable<Score, MACRO>], name: Macroable<JSONTextComponent, MACRO>]) => /*                     */FinalCommandOutput;
            /**
             ...
             * ```
             */
            readonly numberformat: (...args: [...target: [target: Macroable<MultipleEntitiesArgument<MACRO> | number, MACRO>, targetObjective: Macroable<ObjectiveArgument, MACRO>] | [targetScore: Macroable<Score, MACRO>], ...format: [format: "blank"] | [format: "styled", style: Macroable<FormattingTags, MACRO>] | [format: "fixed", rightColumn: Macroable<JSONTextComponent, MACRO>]]) => /*                     */FinalCommandOutput;
        };
    };
}
