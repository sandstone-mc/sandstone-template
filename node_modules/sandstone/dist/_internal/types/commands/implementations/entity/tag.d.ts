...
export declare class TagCommandNode extends CommandNode {
    command: "tag";
}
export declare class TagArgumentsCommand<MACRO extends boolean> extends CommandArguments {
    /**
     ...
     * ```
     */
    add: (name: Macroable<string, MACRO>) => /*                     */FinalCommandOutput;
    /**
     ...
     * ```
     */
    remove: (name: Macroable<string, MACRO>) => /*                     */FinalCommandOutput;
}
export declare class TagCommand<MACRO extends boolean> extends CommandArguments {
    protected NodeType: typeof TagCommandNode;
    /**
     ...
     * ```
     */
    tag: (targets: Macroable<MultipleEntitiesArgument<MACRO>, MACRO>) => TagArgumentsCommand<MACRO>;
}
