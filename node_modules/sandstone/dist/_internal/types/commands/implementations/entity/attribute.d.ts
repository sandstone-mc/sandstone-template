...
import type { SingleEntityArgumentOf } from '../../../arguments/index.js';
import type { Macroable } from '../../../core/index.js';
import { CommandNode } from '../../../core/nodes.js';
import { CommandArguments } from '../../helpers.js';
export declare class AttributeCommandNode extends CommandNode {
    command: "attribute";
}
export declare class AttributeCommand<MACRO extends boolean> extends CommandArguments {
    protected NodeType: typeof AttributeCommandNode;
    /**
     ...
     * ```
     */
    attribute: <T extends string>(target: Macroable<SingleEntityArgumentOf<MACRO, T>, MACRO>, attribute: Macroable<string, MACRO>) => AttributeOperationCommand<boolean>;
}
export declare class AttributeOperationCommand<MACRO extends boolean> extends CommandArguments {
    /**
     * Returns the total value of the specified attribute.
     * @category attribute
     */
    get: (scale?: Macroable<number, MACRO>) => /*                     */FinalCommandOutput;
    /**
     * Returns the base value of the specified attribute.
     * @category attribute
     */
    baseGet: (scale?: Macroable<number, MACRO>) => /*                     */FinalCommandOutput;
    /**
     * Overwrites the base value of the specified attribute with the given value.
     * @category attribute
     */
    baseSet: (value: Macroable<number, MACRO>) => /*                     */FinalCommandOutput;
    /**
     * Overwrites the base value of the specified attribute with the stock value.
     * @category attribute
     */
    baseReset: (value: Macroable<number, MACRO>) => /*                     */FinalCommandOutput;
    /**
     * Adds an attribute modifier with the specified properties if no modifier with the same ID already existed.
     * @category attribute
     */
    add: (id: Macroable<`${string}:${string}`, MACRO>, value: Macroable<number, MACRO>, modifier: Macroable<"add_value" | "add_multiplied_base" | "add_multiplied_total", MACRO>) => /*                     */FinalCommandOutput;
    ...
    getModifierValue: (id: Macroable<`${string}:${string}`, MACRO>, scale?: Macroable<number, MACRO>) => /*                     */FinalCommandOutput;
}
