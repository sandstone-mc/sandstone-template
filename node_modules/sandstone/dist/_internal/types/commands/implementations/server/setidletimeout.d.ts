...
export declare class SetIdleTimeoutCommandNode extends CommandNode {
    command: "setidletimeout";
}
export declare class SetIdleTimeoutCommand extends CommandArguments {
    protected NodeType: typeof SetIdleTimeoutCommandNode;
    /**
     ...
     * ```
     */
    setidletimeout: (minutes: number) => /*                     */FinalCommandOutput;
}
//# sourceMappingURL=setidletimeout.d.ts.map