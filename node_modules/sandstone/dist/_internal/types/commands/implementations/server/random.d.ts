...
import type { Range } from '../../../arguments/index.js';
...
export declare class RandomCommandNode extends CommandNode {
    command: "random";
}
export declare class RandomCommand<MACRO extends boolean> extends CommandArguments {
    protected NodeType: typeof RandomCommandNode;
    /**
     ...
     * ```
     */
    value: (range: Macroable<Range<MACRO>, MACRO>, sequence: Macroable<string, MACRO>) => /*                     */FinalCommandOutput;
    /**
     ...
     * ```
     */
    roll: (range: Macroable<Range<MACRO>, MACRO>, sequence?: Macroable<string, MACRO>) => /*                     */FinalCommandOutput;
    /**
     ...
     * ```
     */
    reset: (sequence: Macroable<LiteralUnion<"*">, MACRO>, seed?: Macroable<number, MACRO>, includeWorldSeed?: Macroable<boolean, MACRO>, includeSequenceID?: Macroable<boolean, MACRO>) => /*                     */FinalCommandOutput;
}
