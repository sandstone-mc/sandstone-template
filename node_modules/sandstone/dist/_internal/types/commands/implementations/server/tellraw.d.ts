...
import type { JSONTextComponent, MultiplePlayersArgumentOf } from '../../../arguments/index.js';
import type { Macroable } from '../../../core/index.js';
import { CommandNode } from '../../../core/nodes.js';
import { CommandArguments } from '../../helpers.js';
export declare class TellRawCommandNode extends CommandNode {
    command: "tellraw";
}
export declare class TellRawCommand<MACRO extends boolean> extends CommandArguments {
    protected NodeType: typeof TellRawCommandNode;
    /**
     ...
     * ```
     */
    tellraw: <T extends string>(targets: Macroable<MultiplePlayersArgumentOf<MACRO, T>, MACRO>, message: Macroable<JSONTextComponent, MACRO>) => /*                     */FinalCommandOutput;
}
