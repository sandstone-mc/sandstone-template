...
import type { Coordinates, Registry } from '../../../arguments/index.js';
import type { Macroable } from '../../../core/index.js';
import { CommandNode } from '../../../core/nodes.js';
import { CommandArguments } from '../../helpers.js';
export declare class CloneCommandNode extends CommandNode {
    command: "clone";
}
export declare class CloneCommand<MACRO extends boolean> extends CommandArguments {
    protected NodeType: typeof CloneCommandNode;
    /**
     ...
     * ```
     */
    clone(begin: Macroable<Coordinates<MACRO>, MACRO>, end: Macroable<Coordinates<MACRO>, MACRO>, destination: Macroable<Coordinates<MACRO>, MACRO>): CloneOptionsCommand<MACRO>;
    /**
     * Clone blocks from a source region in a different dimension to a destination.
     */
    clone(): CloneFromDimensionCommand<MACRO>;
}
export declare class CloneFromDimensionCommand<MACRO extends boolean> extends CommandArguments {
    /**
     ...
     * ```
     */
    from(dimension: Macroable<Registry['minecraft:dimension_type'], MACRO>, begin: Macroable<Coordinates<MACRO>, MACRO>, end: Macroable<Coordinates<MACRO>, MACRO>, destination: Macroable<Coordinates<MACRO>, MACRO>): CloneOptionsCommand<MACRO>;
    /**
     ...
     */
    from(dimension: Macroable<Registry['minecraft:dimension_type'], MACRO>, begin: Macroable<Coordinates<MACRO>, MACRO>, end: Macroable<Coordinates<MACRO>, MACRO>): CloneToDimensionCommand<MACRO>;
}
export declare class CloneToDimensionCommand<MACRO extends boolean> extends CommandArguments {
    /**
     * Clone blocks from a source region in a specific dimension to a destination in a specific dimension.
     *
     * Copies all blocks within the defined 3D region to the new location.
     ...
     * ```
     */
    to: (dimension: Macroable<Registry["minecraft:dimension_type"], MACRO>, destination: Macroable<Coordinates<MACRO>, MACRO>) => CloneOptionsCommand<MACRO>;
}
export declare class CloneOptionsCommand<MACRO extends boolean> extends CommandArguments {
    /**
     ...
     * ```
     */
    strict: () => CloneStrictOptionsCommand<MACRO>;
    /**
     ...
     * ```
     */
    filtered: (filter: Macroable<Registry["minecraft:block"], MACRO>) => CloneModeCommand;
}
/**
 * Provides filter mode options after `strict` has been called.
 * This class is executable on its own (strict with no filter mode).
 */
export declare class CloneStrictOptionsCommand<MACRO extends boolean> extends CommandArguments {
    /**
 ...
 */
export declare class CloneModeCommand extends CommandArguments {
    /**
