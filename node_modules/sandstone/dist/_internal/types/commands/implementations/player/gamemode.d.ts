...
import type { GAMEMODES, MultiplePlayersArgumentOf } from '../../../arguments/index.js';
import type { Macroable } from '../../../core/index.js';
import { CommandNode } from '../../../core/nodes.js';
import { CommandArguments } from '../../helpers.js';
export declare class GameModeCommandNode extends CommandNode {
    command: "gamemode";
}
export declare class GameModeCommand<MACRO extends boolean> extends CommandArguments {
    protected NodeType: typeof GameModeCommandNode;
    /**
     ...
     * ```
     */
    gamemode: <T extends string>(gamemode: Macroable<GAMEMODES, MACRO>, targets?: Macroable<MultiplePlayersArgumentOf<MACRO, T>, MACRO>) => /*                     */FinalCommandOutput;
}
