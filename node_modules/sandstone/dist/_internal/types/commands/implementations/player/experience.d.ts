...
import type { MultiplePlayersArgumentOf, SinglePlayerArgumentOf } from '../../../arguments/index.js';
import type { Macroable } from '../../../core/index.js';
import { CommandNode } from '../../../core/nodes.js';
import { CommandArguments } from '../../helpers.js';
export declare class ExperienceCommandNode extends CommandNode {
    command: "xp";
}
export declare class ExperienceCommand<MACRO extends boolean> extends CommandArguments {
    protected NodeType: typeof ExperienceCommandNode;
    /**
     ...
     * ```
     */
    add: <T extends string>(targets: Macroable<MultiplePlayersArgumentOf<MACRO, T>, MACRO>, amount: Macroable<number, MACRO>, type?: Macroable<"levels" | "points", MACRO>) => /*                     */FinalCommandOutput;
    /**
     ...
     * ```
     */
    set: <T extends string>(targets: Macroable<MultiplePlayersArgumentOf<MACRO, T>, MACRO>, amount: Macroable<number, MACRO>, type?: Macroable<"levels" | "points", MACRO>) => /*                     */FinalCommandOutput;
    /**
     ...
     * ```
     */
    query: <T extends string>(target: Macroable<SinglePlayerArgumentOf<MACRO, T>, MACRO>, type?: Macroable<"levels" | "points", MACRO>) => /*                     */FinalCommandOutput;
}
