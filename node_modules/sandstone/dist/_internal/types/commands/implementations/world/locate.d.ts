...
export declare class LocateCommandNode extends CommandNode {
    command: "locate";
}
export declare class LocateCommand<MACRO extends boolean> extends CommandArguments {
    protected NodeType: typeof LocateCommandNode;
    /**
     ...
     * ```
     */
    structure: (structure: Macroable<Registry["minecraft:worldgen/structure"], MACRO>) => /*                     */FinalCommandOutput;
    /**
     ...
     * ```
     */
    biome: (biome: Macroable<Registry["minecraft:worldgen/biome"], MACRO>) => /*                     */FinalCommandOutput;
    /**
    ...
    poi: (pointOfInterest: Macroable<Registry["minecraft:point_of_interest_type"], MACRO>) => /*                     */FinalCommandOutput;
}
