...
export type handlerReadFile = ((relativePath: string) => Promise<string>) | ((relativePath: string, encoding: BufferEncoding) => Promise<ArrayBuffer | Buffer | string>);
...
export declare abstract class PackType {
     ...
     */
    constructor(type: string, clientPath: string, serverPath: string, rootPath: string, networkSides: 'client' | 'server' | 'both', archiveOutput?: boolean, resourceSubFolder?: string, namespaced?: boolean);
}
