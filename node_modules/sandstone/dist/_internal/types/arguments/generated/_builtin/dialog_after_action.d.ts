...
type McdocDialogAfterActionFallback = (McdocDialogAfterActionClose | McdocDialogAfterActionNone | McdocDialogAfterActionWaitForResponse);
...
export type SymbolMcdocDialogAfterAction<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? McdocDialogAfterActionDispatcherMap : CASE extends 'keys' ? McdocDialogAfterActionKeys : CASE extends '%fallback' ? McdocDialogAfterActionFallback : CASE extends '%none' ? McdocDialogAfterActionNoneType : never;
export {};
//# sourceMappingURL=dialog_after_action.d.ts.map