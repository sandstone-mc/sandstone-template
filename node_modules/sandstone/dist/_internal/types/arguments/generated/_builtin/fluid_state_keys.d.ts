...
type McdocFluidStateKeysFallback = (McdocFluidStateKeysFlowingLava | McdocFluidStateKeysFlowingWater | McdocFluidStateKeysLava | McdocFluidStateKeysWater);
...
export type SymbolMcdocFluidStateKeys<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? McdocFluidStateKeysDispatcherMap : CASE extends 'keys' ? McdocFluidStateKeysKeys : CASE extends '%fallback' ? McdocFluidStateKeysFallback : never;
export {};
//# sourceMappingURL=fluid_state_keys.d.ts.map