...
type McdocFluidStatesFallback = (McdocFluidStatesFlowingLava | McdocFluidStatesFlowingWater | McdocFluidStatesLava | McdocFluidStatesWater | McdocFluidStatesFallbackType);
...
export type SymbolMcdocFluidStates<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? McdocFluidStatesDispatcherMap : CASE extends 'keys' ? McdocFluidStatesKeys : CASE extends '%fallback' ? McdocFluidStatesFallback : CASE extends '%none' ? McdocFluidStatesNoneType : CASE extends '%unknown' ? McdocFluidStatesFallbackType : never;
export {};
//# sourceMappingURL=fluid_states.d.ts.map