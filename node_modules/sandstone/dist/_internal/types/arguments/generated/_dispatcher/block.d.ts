import type { SymbolBlockEntity } from '../dispatcher.js';
import type { BlockEntity } from '../world/block.js';
import type { Skull } from '../world/block/head.js';
...
type BlockBlastFurnace = SymbolBlockEntity['blast_furnace'];
...
type BlockSmoker = SymbolBlockEntity['smoker'];
...
export type SymbolBlock<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? BlockDispatcherMap : CASE extends 'keys' ? BlockKeys : CASE extends '%fallback' ? BlockFallback : never;
export {};
