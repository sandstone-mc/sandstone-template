...
type StatisticTypeFallback = (StatisticTypeBroken | StatisticTypeCrafted | StatisticTypeCustom | StatisticTypeDropped | StatisticTypeKilled | StatisticTypeKilledBy | StatisticTypeMined | StatisticTypePickedUp | StatisticTypeUsed | StatisticTypeFallbackType);
...
export type SymbolStatisticType<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? StatisticTypeDispatcherMap : CASE extends 'keys' ? StatisticTypeKeys : CASE extends '%fallback' ? StatisticTypeFallback : CASE extends '%unknown' ? StatisticTypeFallbackType : never;
export {};
//# sourceMappingURL=statistic_type.d.ts.map