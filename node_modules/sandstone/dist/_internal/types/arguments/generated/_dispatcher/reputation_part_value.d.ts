...
type ReputationPartValueFallback = (ReputationPartValueMajorNegative | ReputationPartValueMajorPositive | ReputationPartValueMinorNegative | ReputationPartValueMinorPositive | ReputationPartValueTrading);
...
export type SymbolReputationPartValue<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? ReputationPartValueDispatcherMap : CASE extends 'keys' ? ReputationPartValueKeys : CASE extends '%fallback' ? ReputationPartValueFallback : never;
export {};
//# sourceMappingURL=reputation_part_value.d.ts.map