import type { DynamicCustomAction, DynamicRunCommand } from '../data/dialog/action.js';
import type { ChangePage, CopyToClipboard, CustomAction, OpenUrl, RunCommand, ShowDialog, SuggestCommand } from '../util/text.js';
...
type DialogActionFallback = (DialogActionChangePage | DialogActionCopyToClipboard | DialogActionCustom | DialogActionDynamicCustom | DialogActionDynamicRunCommand | DialogActionOpenUrl | DialogActionRunCommand | DialogActionShowDialog | DialogActionSuggestCommand);
...
export type SymbolDialogAction<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? DialogActionDispatcherMap : CASE extends 'keys' ? DialogActionKeys : CASE extends '%fallback' ? DialogActionFallback : never;
export {};
//# sourceMappingURL=dialog_action.d.ts.map