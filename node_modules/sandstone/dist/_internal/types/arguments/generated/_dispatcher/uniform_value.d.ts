...
type UniformValueFallback = (UniformValueFloat | UniformValueInt | UniformValueIvec3 | UniformValueMatrix4x4 | UniformValueVec2 | UniformValueVec3 | UniformValueVec4);
...
export type SymbolUniformValue<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? UniformValueDispatcherMap : CASE extends 'keys' ? UniformValueKeys : CASE extends '%fallback' ? UniformValueFallback : never;
export {};
//# sourceMappingURL=uniform_value.d.ts.map