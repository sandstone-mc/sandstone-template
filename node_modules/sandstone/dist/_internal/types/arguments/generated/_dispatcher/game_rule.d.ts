import type { NBTInt } from '../../../../index.js';
...
type GameRuleFallback = (GameRuleAdvanceTime | GameRuleAdvanceWeather | GameRuleAllowEnteringNetherUsingPortals | GameRuleBlockDrops | GameRuleBlockExplosionDropDecay | GameRuleCommandBlockOutput | GameRuleCommandBlocksWork | GameRuleDrowningDamage | GameRuleElytraMovementCheck | GameRuleEnderPearlsVanishOnDeath | GameRuleEntityDrops | GameRuleFallDamage | GameRuleFireDamage | GameRuleFireSpreadRadiusAroundPlayer | GameRuleForgiveDeadPlayers | GameRuleFreezeDamage | GameRuleGlobalSoundEvents | GameRuleImmediateRespawn | GameRuleKeepInventory | GameRuleLavaSourceConversion | GameRuleLimitedCrafting | GameRuleLocatorBar | GameRuleLogAdminCommands | GameRuleMaxBlockModifications | GameRuleMaxCommandForks | GameRuleMaxCommandSequenceLength | GameRuleMaxEntityCramming | GameRuleMaxMinecartSpeed | GameRuleMaxSnowAccumulationHeight | GameRuleMobDrops | GameRuleMobExplosionDropDecay | GameRuleMobGriefing | GameRuleNaturalHealthRegeneration | GameRulePlayerMovementCheck | GameRulePlayersNetherPortalCreativeDelay | GameRulePlayersNetherPortalDefaultDelay | GameRulePlayersSleepingPercentage | GameRuleProjectilesCanBreakBlocks | GameRulePvp | GameRuleRaids | GameRuleRandomTickSpeed | GameRuleReducedDebugInfo | GameRuleRespawnRadius | GameRuleSendCommandFeedback | GameRuleShowDeathMessages | GameRuleSpawnMobs | GameRuleSpawnMonsters | GameRuleSpawnPatrols | GameRuleSpawnPhantoms | GameRuleSpawnWanderingTraders | GameRuleSpawnWardens | GameRuleSpawnerBlocksWork | GameRuleSpectatorsGenerateChunks | GameRuleSpreadVines | GameRuleTntExplodes | GameRuleTntExplosionDropDecay | GameRuleUniversalAnger | GameRuleWaterSourceConversion);
...
export type SymbolGameRule<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? GameRuleDispatcherMap : CASE extends 'keys' ? GameRuleKeys : CASE extends '%fallback' ? GameRuleFallback : never;
export {};
//# sourceMappingURL=game_rule.d.ts.map