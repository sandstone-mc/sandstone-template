import type { NumberProvider } from '../data/number_provider.js';
import type { SymbolMcdocBlockItemStates } from '../dispatcher.js';
import type { Registry } from '../registry.js';
import type { LegacyOperation } from '../util/attribute.js';
import type { EquipmentSlotGroup } from '../util/slot.js';
import type { BlockEntityData } from './block.js';
import type { DataComponentExactPredicate, DataComponentPatch } from './component.js';
import type { Trim } from './component/item.js';
import type { NBTObject } from '../../nbt.js';
import type { EnchantmentClass, NBTDouble, NBTInt, NBTIntArray, NBTShort } from '../../../../index.js';
...
export type BlockItem<S = undefined> = (ItemBase & {
     ...
     */
    BlockStateTag?: (S extends undefined ? SymbolMcdocBlockItemStates<'%none'> : (S extends keyof SymbolMcdocBlockItemStates ? SymbolMcdocBlockItemStates[S] : SymbolMcdocBlockItemStates<'%unknown'>));
});
export type Display = {
    /**
