...
import type { WritableBook, WrittenBook } from './book.js';
import type { Compass } from './compass.js';
import type { Crossbow } from './crossbow.js';
import type { DebugStick } from './debug_stick.js';
import type { EnchantedBook } from './enchanted_book.js';
import type { FireworkRocket, FireworkStar } from './firework.js';
import type { AxolotlBucket, BasicFishBucket } from './fish_bucket.js';
import type { GoatHorn } from './goat_horn.js';
import type { PlayerHead } from './head.js';
import type { ItemBase } from '../item.js';
import type { KnowledgeBook } from './knowledge_book.js';
import type { LeatherArmor } from './leather_armor.js';
import type { FilledMap } from './map.js';
import type { EffectItem } from './potion.js';
import type { Shield } from './shield.js';
import type { SuspiciousStew } from './suspicious_stew.js';
...
type ItemFallback = (ItemAcaciaBoat | ItemAcaciaChestBoat | ItemAllaySpawnEgg | ItemArmadilloSpawnEgg | ItemArmorStand | ItemAxolotlBucket | ItemAxolotlSpawnEgg | ItemBambooChestRaft | ItemBambooRaft | ItemBatSpawnEgg | ItemBeeSpawnEgg | ItemBirchBoat | ItemBirchChestBoat | ItemBlazeSpawnEgg | ItemBoggedSpawnEgg | ItemBreezeSpawnEgg | ItemCamelHuskSpawnEgg | ItemCamelSpawnEgg | ItemCatSpawnEgg | ItemCaveSpiderSpawnEgg | ItemCherryBoat | ItemCherryChestBoat | ItemChestMinecart | ItemChickenSpawnEgg | ItemCodBucket | ItemCodSpawnEgg | ItemCommandBlockMinecart | ItemCompass | ItemCopperGolemSpawnEgg | ItemCowSpawnEgg | ItemCreakingSpawnEgg | ItemCreeperSpawnEgg | ItemCrossbow | ItemDarkOakBoat | ItemDarkOakChestBoat | ItemDebugStick | ItemDolphinSpawnEgg | ItemDonkeySpawnEgg | ItemDrownedSpawnEgg | ItemElderGuardianSpawnEgg | ItemEnchantedBook | ItemEnderDragonSpawnEgg | ItemEndermanSpawnEgg | ItemEndermiteSpawnEgg | ItemEvokerSpawnEgg | ItemFilledMap | ItemFireworkRocket | ItemFireworkStar | ItemFoxSpawnEgg | ItemFrogSpawnEgg | ItemFurnaceMinecart | ItemGhastSpawnEgg | ItemGlowItemFrame | ItemGlowSquidSpawnEgg | ItemGoatHorn | ItemGoatSpawnEgg | ItemGuardianSpawnEgg | ItemHappyGhastSpawnEgg | ItemHoglinSpawnEgg | ItemHopperMinecart | ItemHorseSpawnEgg | ItemHuskSpawnEgg | ItemIronGolemSpawnEgg | ItemItemFrame | ItemJungleBoat | ItemJungleChestBoat | ItemKnowledgeBook | ItemLeatherBoots | ItemLeatherChestplate | ItemLeatherHelmet | ItemLeatherHorseArmor | ItemLeatherLeggings | ItemLingeringPotion | ItemLlamaSpawnEgg | ItemMagmaCubeSpawnEgg | ItemMangroveBoat | ItemMangroveChestBoat | ItemMinecart | ItemMooshroomSpawnEgg | ItemMuleSpawnEgg | ItemNautilusSpawnEgg | ItemOakBoat | ItemOakChestBoat | ItemOcelotSpawnEgg | ItemPainting | ItemPandaSpawnEgg | ItemParchedSpawnEgg | ItemParrotSpawnEgg | ItemPhantomSpawnEgg | ItemPigSpawnEgg | ItemPiglinBruteSpawnEgg | ItemPiglinSpawnEgg | ItemPillagerSpawnEgg | ItemPlayerHead | ItemPolarBearSpawnEgg | ItemPotion | ItemPufferfishBucket | ItemPufferfishSpawnEgg | ItemRabbitSpawnEgg | ItemRavagerSpawnEgg | ItemSalmonBucket | ItemSalmonSpawnEgg | ItemSheepSpawnEgg | ItemShield | ItemShulkerSpawnEgg | ItemSilverfishSpawnEgg | ItemSkeletonHorseSpawnEgg | ItemSkeletonSpawnEgg | ItemSlimeSpawnEgg | ItemSnifferSpawnEgg | ItemSnowGolemSpawnEgg | ItemSpiderSpawnEgg | ItemSplashPotion | ItemSpruceBoat | ItemSpruceChestBoat | ItemSquidSpawnEgg | ItemStraySpawnEgg | ItemStriderSpawnEgg | ItemSuspiciousStew | ItemTadpoleBucket | ItemTadpoleSpawnEgg | ItemTippedArrow | ItemTntMinecart | ItemTraderLlamaSpawnEgg | ItemTropicalFishBucket | ItemTropicalFishSpawnEgg | ItemTurtleSpawnEgg | ItemVexSpawnEgg | ItemVillagerSpawnEgg | ItemVindicatorSpawnEgg | ItemWanderingTraderSpawnEgg | ItemWardenSpawnEgg | ItemWitchSpawnEgg | ItemWitherSkeletonSpawnEgg | ItemWitherSpawnEgg | ItemWolfSpawnEgg | ItemWritableBook | ItemWrittenBook | ItemZoglinSpawnEgg | ItemZombieHorseSpawnEgg | ItemZombieNautilusSpawnEgg | ItemZombieSpawnEgg | ItemZombieVillagerSpawnEgg | ItemZombifiedPiglinSpawnEgg | ItemFallbackType);
...
export type SymbolItem<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? ItemDispatcherMap : CASE extends 'keys' ? ItemKeys : CASE extends '%fallback' ? ItemFallback : CASE extends '%unknown' ? ItemFallbackType : never;
export {};
//# sourceMappingURL=spawn_item.d.ts.map