import type { InclusiveRange } from './util.js';
import type { Text } from './util/text.js';
import type { NBTInt, NBTList } from '../../../index.js';
export type BlockPattern = {
    namespace?: `${any}${string}` | RegExp;
    path?: `${any}${string}` | RegExp;
};
export type FeatureFlag = ('vanilla' | 'update_1_20' | 'bundle' | 'trade_rebalance' | 'update_1_21' | 'redstone_experiments' | 'minecart_improvements' | 'winter_drop');
export type Pack = {
    pack: {
        description: Text;
        pack_format?: NBTInt;
