...
import type { NBTDouble, TextureClass } from '../../../../index.js';
export type Atlas = {
    /**
...
type SpriteSourceFallback = (SpriteSourceDirectory | SpriteSourceFilter | SpriteSourcePalettedPermutations | SpriteSourceSingle | SpriteSourceUnstitch);
...
export type SymbolSpriteSource<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? SpriteSourceDispatcherMap : CASE extends 'keys' ? SpriteSourceKeys : CASE extends '%fallback' ? SpriteSourceFallback : never;
export {};
