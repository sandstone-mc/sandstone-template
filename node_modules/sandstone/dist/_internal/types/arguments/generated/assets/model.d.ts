...
import type { ModelType, TextureType } from '../../index.js';
import type { ModelClass, NBTFloat, NBTInt, NBTList, TextureClass } from '../../../../index.js';
export type Axis = ('x' | 'y' | 'z');
export type CustomizableItemDisplayContext = ('firstperson_righthand' | 'firstperson_lefthand' | 'thirdperson_righthand' | 'thirdperson_lefthand' | 'gui' | 'head' | 'ground' | 'fixed' | 'on_shelf');
export type ItemDisplayContext = ('none' | 'firstperson_righthand' | 'firstperson_lefthand' | 'thirdperson_righthand' | 'thirdperson_lefthand' | 'gui' | 'head' | 'ground' | 'fixed' | 'on_shelf');
...
export type Predicates = ('angle' | 'blocking' | 'broken' | 'cast' | 'charged' | 'cooldown' | 'custom_model_data' | 'damage' | 'damaged' | 'firework' | 'honey_level' | 'lefthanded' | 'level' | 'pull' | 'pulling' | 'throwing' | 'time' | 'tooting' | 'trim_type');
