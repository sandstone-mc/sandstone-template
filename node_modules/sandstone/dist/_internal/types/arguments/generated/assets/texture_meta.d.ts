import type { PaletteRef } from './atlas.js';
...
export type SymbolGuiSpriteScaling<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? GuiSpriteScalingDispatcherMap : CASE extends 'keys' ? GuiSpriteScalingKeys : CASE extends '%fallback' ? GuiSpriteScalingFallback : never;
export {};
//# sourceMappingURL=texture_meta.d.ts.map