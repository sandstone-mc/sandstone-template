...
import type { FontClass, NBTFloat, NBTInt, NBTList } from '../../../../index.js';
...
type GlyphProviderFallback = (GlyphProviderBitmap | GlyphProviderReference | GlyphProviderSpace | GlyphProviderTtf | GlyphProviderUnihex);
...
export type SymbolGlyphProvider<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? GlyphProviderDispatcherMap : CASE extends 'keys' ? GlyphProviderKeys : CASE extends '%fallback' ? GlyphProviderFallback : never;
export {};
