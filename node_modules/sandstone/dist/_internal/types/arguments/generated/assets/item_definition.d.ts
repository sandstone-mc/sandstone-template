import type { ItemDisplayContext, ModelRef } from './model.js';
import type { SymbolDataComponent, SymbolDataComponentPredicate, SymbolMcdocBlockStateKeys } from '../dispatcher.js';
import type { Registry } from '../registry.js';
import type { HumanoidArm } from '../util/avatar.js';
import type { DyeColor, RGB } from '../util/color.js';
import type { Keybind } from '../util/text.js';
import type { Transformation } from '../world/entity/display.js';
import type { NBTObject, RootNBT } from '../../nbt.js';
import type { NBTFloat, NBTInt, NBTList, TrimMaterialClass } from '../../../../index.js';
/**
 * *either*
 *
 * *item 0*
...
export type ComponentFlags = NonNullable<({
    [S in Extract<Extract<Registry['minecraft:data_component_predicate_type'], string>, string>]?: {
         ...
         */
        value: (S extends keyof SymbolDataComponentPredicate ? SymbolDataComponentPredicate[S] : SymbolDataComponentPredicate<'%unknown'>);
    };
...
export type Condition = NonNullable<({
    [S in Extract<Extract<ConditionalPropertyType, string>, string>]?: ({
        ...
        on_false: ItemModel;
        transformation?: Transformation;
    } & (S extends keyof SymbolConditionalItemProperty ? SymbolConditionalItemProperty[S] : SymbolConditionalItemProperty<'%unknown'>));
}[Extract<ConditionalPropertyType, string>])>;
export type ConditionalPropertyType = ('broken' | 'bundle/has_selected_item' | 'carried' | 'component' | 'custom_model_data' | 'damaged' | 'extended_view' | 'fishing_rod/cast' | 'has_component' | 'keybind_down' | 'selected' | 'using_item' | 'view_entity');
...
export type ItemModeltype = ('bundle/selected_item' | 'composite' | 'condition' | 'empty' | 'model' | 'range_dispatch' | 'select' | 'special');
...
export type NumericPropertyType = ('bundle/fullness' | 'compass' | 'cooldown' | 'count' | 'crossbow/pull' | 'custom_model_data' | 'damage' | 'time' | 'use_cycle' | 'use_duration');
...
export type RangeDispatch = NonNullable<({
    [S in Extract<Extract<NumericPropertyType, string>, string>]?: ({
        ...
        fallback?: ItemModel;
        transformation?: Transformation;
    } & (S extends keyof SymbolNumericItemProperty ? SymbolNumericItemProperty[S] : SymbolNumericItemProperty<'%unknown'>));
...
export type Select = NonNullable<({
    [S in Extract<Extract<SelectPropertyType, string>, string>]?: ({
        ...
        fallback?: ItemModel;
        transformation?: Transformation;
    } & (S extends keyof SymbolSelectItemProperty ? SymbolSelectItemProperty[S] : SymbolSelectItemProperty<'%unknown'>));
...
export type SelectPropertyType = ('block_state' | 'charge_type' | 'component' | 'context_dimension' | 'context_entity_type' | 'custom_model_data' | 'display_context' | 'local_time' | 'main_hand' | 'trim_material');
...
export type SpecialModelType = ('banner' | 'bed' | 'bell' | 'book' | 'conduit' | 'chest' | 'copper_golem_statue' | 'decorated_pot' | 'end_cube' | 'hanging_sign' | 'head' | 'player_head' | 'shield' | 'shulker_box' | 'standing_sign' | 'trident');
...
export type TintSourceType = ('constant' | 'custom_model_data' | 'dye' | 'firework' | 'grass' | 'map_color' | 'potion' | 'team');
...
export type WoodType = ('oak' | 'spruce' | 'birch' | 'acacia' | 'cherry' | 'jungle' | 'dark_oak' | 'pale_oak' | 'mangrove' | 'bamboo' | 'crimson' | 'warped');
...
type ConditionalItemPropertyFallback = (ConditionalItemPropertyComponent | ConditionalItemPropertyCustomModelData | ConditionalItemPropertyHasComponent | ConditionalItemPropertyKeybindDown | ConditionalItemPropertyViewEntity | ConditionalItemPropertyFallbackType);
...
export type SymbolConditionalItemProperty<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? ConditionalItemPropertyDispatcherMap : CASE extends 'keys' ? ConditionalItemPropertyKeys : CASE extends '%fallback' ? ConditionalItemPropertyFallback : CASE extends '%unknown' ? ConditionalItemPropertyFallbackType : never;
...
type ItemModelFallback = (ItemModelBundleSelectedItem | ItemModelComposite | ItemModelCondition | ItemModelModel | ItemModelRangeDispatch | ItemModelSelect | ItemModelSpecial);
...
export type SymbolItemModel<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? ItemModelDispatcherMap : CASE extends 'keys' ? ItemModelKeys : CASE extends '%fallback' ? ItemModelFallback : never;
...
type NumericItemPropertyFallback = (NumericItemPropertyCompass | NumericItemPropertyCount | NumericItemPropertyCustomModelData | NumericItemPropertyDamage | NumericItemPropertyTime | NumericItemPropertyUseCycle | NumericItemPropertyUseDuration | NumericItemPropertyFallbackType);
...
export type SymbolNumericItemProperty<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? NumericItemPropertyDispatcherMap : CASE extends 'keys' ? NumericItemPropertyKeys : CASE extends '%fallback' ? NumericItemPropertyFallback : CASE extends '%unknown' ? NumericItemPropertyFallbackType : never;
...
type SelectItemPropertyFallback = (SelectItemPropertyBlockState | SelectItemPropertyChargeType | SelectItemPropertyComponent | SelectItemPropertyContextDimension | SelectItemPropertyContextEntityType | SelectItemPropertyCustomModelData | SelectItemPropertyDisplayContext | SelectItemPropertyLocalTime | SelectItemPropertyMainHand | SelectItemPropertyTrimMaterial | SelectItemPropertyFallbackType);
...
export type SymbolSelectItemProperty<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? SelectItemPropertyDispatcherMap : CASE extends 'keys' ? SelectItemPropertyKeys : CASE extends '%fallback' ? SelectItemPropertyFallback : CASE extends '%unknown' ? SelectItemPropertyFallbackType : never;
...
type SpecialItemModelFallback = (SpecialItemModelBanner | SpecialItemModelBed | SpecialItemModelBook | SpecialItemModelChest | SpecialItemModelCopperGolemStatue | SpecialItemModelEndCube | SpecialItemModelHangingSign | SpecialItemModelHead | SpecialItemModelShulkerBox | SpecialItemModelStandingSign | SpecialItemModelFallbackType);
...
export type SymbolSpecialItemModel<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? SpecialItemModelDispatcherMap : CASE extends 'keys' ? SpecialItemModelKeys : CASE extends '%fallback' ? SpecialItemModelFallback : CASE extends '%unknown' ? SpecialItemModelFallbackType : never;
...
type TintSourceFallback = (TintSourceConstant | TintSourceCustomModelData | TintSourceDye | TintSourceFirework | TintSourceGrass | TintSourceMapColor | TintSourcePotion | TintSourceTeam);
...
export type SymbolTintSource<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? TintSourceDispatcherMap : CASE extends 'keys' ? TintSourceKeys : CASE extends '%fallback' ? TintSourceFallback : never;
export {};
//# sourceMappingURL=item_definition.d.ts.map