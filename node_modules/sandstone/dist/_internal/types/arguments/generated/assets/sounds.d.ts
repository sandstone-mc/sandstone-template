import type { SymbolSoundType } from '../dispatcher.js';
import type { Registry } from '../registry.js';
import type { RootNBT } from '../../nbt.js';
import type { NBTFloat, NBTInt, SoundEventClass } from '../../../../index.js';
export type Sound = NonNullable<({
    [S in Extract<Extract<SoundType, string>, string>]?: {
         ...
         */
        type?: S;
        name: (S extends undefined ? SymbolSoundType<'%none'> : (S extends keyof SymbolSoundType ? SymbolSoundType[S] : RootNBT));
        /**
         * Defaults to 1.0.
         *
         * Value:
