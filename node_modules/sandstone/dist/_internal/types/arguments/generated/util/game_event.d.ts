...
export type SymbolPositionSource<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? PositionSourceDispatcherMap : CASE extends 'keys' ? PositionSourceKeys : CASE extends '%fallback' ? PositionSourceFallback : never;
export {};
