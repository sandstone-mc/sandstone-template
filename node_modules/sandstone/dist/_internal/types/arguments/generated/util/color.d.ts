import type { BlendToGray } from '../data/worldgen/attribute/modifier.js';
import type { NBTFloat, NBTInt, NBTList } from '../../../../index.js';
export type DyeColor = ('white' | 'orange' | 'magenta' | 'light_blue' | 'yellow' | 'lime' | 'pink' | 'gray' | 'light_gray' | 'cyan' | 'purple' | 'blue' | 'brown' | 'green' | 'red' | 'black');
...
type EnvironmentAttributeArgbColorModifierFallback = (EnvironmentAttributeArgbColorModifierAdd | EnvironmentAttributeArgbColorModifierAlphaBlend | EnvironmentAttributeArgbColorModifierBlendToGray | EnvironmentAttributeArgbColorModifierMultiply | EnvironmentAttributeArgbColorModifierOverride | EnvironmentAttributeArgbColorModifierSubtract);
...
export type SymbolEnvironmentAttributeArgbColorModifier<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? EnvironmentAttributeArgbColorModifierDispatcherMap : CASE extends 'keys' ? EnvironmentAttributeArgbColorModifierKeys : CASE extends '%fallback' ? EnvironmentAttributeArgbColorModifierFallback : CASE extends '%none' ? EnvironmentAttributeArgbColorModifierNoneType : never;
export {};
