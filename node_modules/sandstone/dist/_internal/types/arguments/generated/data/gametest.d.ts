import type { TestEnvironment } from './gametest/test_environment.js';
import type { Registry } from '../registry.js';
import type { Rotation } from '../util.js';
import type { RootNBT } from '../../nbt.js';
import type { NBTInt, StructureClass, TestEnvironmentClass } from '../../../../index.js';
...
export type SymbolTestInstance<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? TestInstanceDispatcherMap : CASE extends 'keys' ? TestInstanceKeys : CASE extends '%fallback' ? TestInstanceFallback : never;
export {};
//# sourceMappingURL=gametest.d.ts.map