import type { LevelBasedValue } from './level_based_value.js';
import type { SoundEventRef } from '../util.js';
import type { BlockPredicate } from '../worldgen/feature/block_predicate.js';
import type { BlockStateProvider } from '../worldgen/feature/block_state_provider.js';
import type { FloatProvider } from '../worldgen.js';
import type { SymbolDataComponent } from '../../dispatcher.js';
...
import type { DamageTypeClass, LiteralUnion, MCFunctionClass, NBTDouble, NBTFloat, NBTInt, NBTList, TagClass } from '../../../../../index.js';
...
export type ApplyMobEffectEntityEffect = {
     ...
     */
    to_apply: ((Registry['minecraft:mob_effect'] | `#${string}:${string}` | TagClass<'mob_effect'>) | Array<Registry['minecraft:mob_effect']>);
...
export type ExplodeEntityEffect = {
     ...
     */
    immune_blocks?: ((Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | Array<Registry['minecraft:block']>);
    /**
...
export type SummonEntityEffect = {
     ...
     */
    entity: ((Registry['minecraft:entity_type'] | `#${Registry['minecraft:tag/entity_type']}` | TagClass<'entity_type'>) | Array<Registry['minecraft:entity_type']>);
    /**
...
export type SymbolEntityEffect<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? EntityEffectDispatcherMap : CASE extends 'keys' ? EntityEffectKeys : CASE extends '%fallback' ? EntityEffectFallback : never;
...
type LocationBasedEffectFallback = (LocationBasedEffectAllOf | LocationBasedEffectApplyExhaustion | LocationBasedEffectApplyImpulse | LocationBasedEffectApplyMobEffect | LocationBasedEffectAttribute | LocationBasedEffectChangeItemDamage | LocationBasedEffectDamageEntity | LocationBasedEffectExplode | LocationBasedEffectIgnite | LocationBasedEffectPlaySound | LocationBasedEffectReplaceBlock | LocationBasedEffectReplaceDisk | LocationBasedEffectRunFunction | LocationBasedEffectSetBlockProperties | LocationBasedEffectSpawnParticles | LocationBasedEffectSummonEntity);
...
export type SymbolLocationBasedEffect<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? LocationBasedEffectDispatcherMap : CASE extends 'keys' ? LocationBasedEffectKeys : CASE extends '%fallback' ? LocationBasedEffectFallback : never;
...
type ValueEffectFallback = (ValueEffectAdd | ValueEffectAllOf | ValueEffectExponential | ValueEffectMultiply | ValueEffectRemoveBinomial | ValueEffectSet);
...
export type SymbolValueEffect<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? ValueEffectDispatcherMap : CASE extends 'keys' ? ValueEffectKeys : CASE extends '%fallback' ? ValueEffectFallback : never;
export {};
