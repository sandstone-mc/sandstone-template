import type { VerticalAnchor } from '../../worldgen.js';
...
import type { NBTInt, NBTList, TagClass } from '../../../../../../index.js';
...
export type MatchingBlocksPredicate = (PredicateOffset & {
    blocks: (Array<Registry['minecraft:block']> | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>));
});
...
export type MatchingFluidsPredicate = (PredicateOffset & {
    fluids: (Array<Registry['minecraft:fluid']> | (Registry['minecraft:fluid'] | `#${Registry['minecraft:tag/fluid']}` | TagClass<'fluid'>));
});
...
type BlockPredicateFallback = (BlockPredicateAllOf | BlockPredicateAnyOf | BlockPredicateHasSturdyFace | BlockPredicateHeightRange | BlockPredicateInsideWorldBounds | BlockPredicateMatchingBiomes | BlockPredicateMatchingBlockTag | BlockPredicateMatchingBlocks | BlockPredicateMatchingFluids | BlockPredicateNot | BlockPredicateUnobstructed | BlockPredicateWouldSurvive);
...
export type SymbolBlockPredicate<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? BlockPredicateDispatcherMap : CASE extends 'keys' ? BlockPredicateKeys : CASE extends '%fallback' ? BlockPredicateFallback : never;
export {};
//# sourceMappingURL=block_predicate.d.ts.map