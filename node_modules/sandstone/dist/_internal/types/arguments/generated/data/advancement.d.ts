import type { SymbolTrigger } from '../dispatcher.js';
import type { Registry } from '../registry.js';
import type { Text } from '../util/text.js';
import type { ItemStackTemplate } from '../world/item.js';
import type { AdvancementClass, LootTableClass, MCFunctionClass, NBTClass, NBTInt, NBTList, RecipeClass, TextureClass } from '../../../../index.js';
...
export type Trigger = ('allay_drop_item_on_block' | 'avoid_vibration' | 'bee_nest_destroyed' | 'bred_animals' | 'brewed_potion' | 'changed_dimension' | 'channeled_lightning' | 'construct_beacon' | 'consume_item' | 'cured_zombie_villager' | 'effects_changed' | 'enchanted_item' | 'enter_block' | 'entity_hurt_player' | 'entity_killed_player' | 'fall_from_height' | 'filled_bucket' | 'fishing_rod_hooked' | 'hero_of_the_village' | 'impossible' | 'inventory_changed' | 'item_durability_changed' | 'item_used_on_block' | 'kill_mob_near_sculk_catalyst' | 'killed_by_crossbow' | 'levitation' | 'lightning_strike' | 'location' | 'nether_travel' | 'placed_block' | 'player_generates_container_loot' | 'player_hurt_entity' | 'player_interacted_with_entity' | 'player_killed_entity' | 'recipe_crafted' | 'recipe_unlocked' | 'ride_entity_in_lava' | 'shot_crossbow' | 'safely_harvest_honey' | 'slept_in_bed' | 'slide_down_block' | 'started_riding' | 'summoned_entity' | 'tame_animal' | 'target_hit' | 'thrown_item_picked_up_by_entity' | 'thrown_item_picked_up_by_player' | 'tick' | 'used_ender_eye' | 'used_totem' | 'using_item' | 'villager_trade' | 'voluntary_exile');
