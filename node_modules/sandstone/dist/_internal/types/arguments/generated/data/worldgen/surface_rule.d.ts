import type { CaveSurface, VerticalAnchor } from '../worldgen.js';
...
type SurfaceConditionFallback = (SurfaceConditionBiome | SurfaceConditionNoiseThreshold | SurfaceConditionNot | SurfaceConditionStoneDepth | SurfaceConditionVerticalGradient | SurfaceConditionWater | SurfaceConditionYAbove);
...
export type SymbolSurfaceCondition<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? SurfaceConditionDispatcherMap : CASE extends 'keys' ? SurfaceConditionKeys : CASE extends '%fallback' ? SurfaceConditionFallback : never;
...
export type SymbolSurfaceRule<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? SurfaceRuleDispatcherMap : CASE extends 'keys' ? SurfaceRuleKeys : CASE extends '%fallback' ? SurfaceRuleFallback : never;
export {};
//# sourceMappingURL=surface_rule.d.ts.map