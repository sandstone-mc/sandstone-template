import type { GlobalEnvironmentAttributeMap } from './attribute.js';
import type { ChunkGenerator } from './dimension/chunk_generator.js';
import type { IntProvider } from '../worldgen.js';
import type { Registry } from '../../registry.js';
import type { NBTDouble, NBTFloat, NBTInt, TagClass, TimelineClass, WorldClockClass } from '../../../../../index.js';
...
export type DimensionType = {
    ...
    timelines?: ((Registry['minecraft:timeline'] | `#${Registry['minecraft:tag/timeline']}` | TagClass<'timeline'> | TimelineClass) | Array<(Registry['minecraft:timeline'] | TimelineClass)>);
    /**
     ...
     */
    infiniburn: ((`#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | Array<Registry['minecraft:block']>);
    /**
