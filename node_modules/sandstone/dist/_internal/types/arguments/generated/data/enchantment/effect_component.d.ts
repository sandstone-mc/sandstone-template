import type { AttributeEffect, EntityEffect, LocationBasedEffect, ValueEffect } from './effect.js';
...
type EffectComponentFallback = (EffectComponentAmmoUse | EffectComponentArmorEffectiveness | EffectComponentAttributes | EffectComponentBlockExperience | EffectComponentCrossbowChargeTime | EffectComponentCrossbowChargingSounds | EffectComponentDamage | EffectComponentDamageImmunity | EffectComponentDamageProtection | EffectComponentEquipmentDrops | EffectComponentFishingLuckBonus | EffectComponentFishingTimeReduction | EffectComponentHitBlock | EffectComponentItemDamage | EffectComponentKnockback | EffectComponentLocationChanged | EffectComponentMobExperience | EffectComponentPostAttack | EffectComponentPostPiercingAttack | EffectComponentPreventArmorChange | EffectComponentPreventEquipmentDrop | EffectComponentProjectileCount | EffectComponentProjectilePiercing | EffectComponentProjectileSpawned | EffectComponentProjectileSpread | EffectComponentRepairWithXp | EffectComponentSmashDamagePerBlockFallen | EffectComponentTick | EffectComponentTridentReturnAcceleration | EffectComponentTridentSound | EffectComponentTridentSpinAttackStrength);
...
export type SymbolEffectComponent<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? EffectComponentDispatcherMap : CASE extends 'keys' ? EffectComponentKeys : CASE extends '%fallback' ? EffectComponentFallback : never;
export {};
//# sourceMappingURL=effect_component.d.ts.map