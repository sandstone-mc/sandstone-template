...
import type { PredicateRef } from './predicate.js';
import type { ScoreProvider } from './util.js';
import type { NumericalEnvironmentAttribute } from './worldgen/attribute.js';
import type { Registry } from '../registry.js';
import type { NonEmptyWeightedList } from '../util.js';
import type { RootNBT } from '../../nbt.js';
import type { DataPointClass, NBTFloat, ObjectiveClass } from '../../../../index.js';
...
export type NumberProvider = (NBTFloat | ({
    [S in Extract<Extract<Registry['minecraft:loot_number_provider_type'], string>, string>]?: ({
         ...
         */
        type?: S;
    } & (S extends undefined ? SymbolNumberProvider<'%none'> : (S extends keyof SymbolNumberProvider ? SymbolNumberProvider[S] : RootNBT)));
...
type NumberProviderFallback = (NumberProviderBinomial | NumberProviderConstant | NumberProviderEnchantmentLevel | NumberProviderEnvironmentAttribute | NumberProviderScore | NumberProviderStorage | NumberProviderSum | NumberProviderUniform);
...
export type SymbolNumberProvider<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? NumberProviderDispatcherMap : CASE extends 'keys' ? NumberProviderKeys : CASE extends '%fallback' ? NumberProviderFallback : CASE extends '%none' ? NumberProviderNoneType : never;
export {};
//# sourceMappingURL=number_provider.d.ts.map