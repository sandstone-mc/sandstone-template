...
import type { PotionsPredicate } from '../world/component/predicate.js';
import type { ItemStack, ItemStackTemplate } from '../world/item.js';
import type { CRAFTING_INGREDIENT, PatternKeys, StringSmallerThan4 } from '../../index.js';
import type { NBTFloat, NBTInt, NBTList, RecipeClass, TagClass, TrimPatternClass } from '../../../../index.js';
export type Brewing = {
    /**
     * The original potion.
     */
...
export type RecipeListRef = ((Registry['minecraft:recipe'] | `#${string}:${string}` | TagClass<'recipe'> | RecipeClass) | Array<(Registry['minecraft:recipe'] | RecipeClass)>);
...
type RecipeSerializerFallback = (RecipeSerializerBlasting | RecipeSerializerCampfireCooking | RecipeSerializerCraftingDecoratedPot | RecipeSerializerCraftingDye | RecipeSerializerCraftingImbue | RecipeSerializerCraftingShaped | RecipeSerializerCraftingShapeless | RecipeSerializerCraftingSpecialBannerduplicate | RecipeSerializerCraftingSpecialBookcloning | RecipeSerializerCraftingSpecialFireworkRocket | RecipeSerializerCraftingSpecialFireworkStar | RecipeSerializerCraftingSpecialFireworkStarFade | RecipeSerializerCraftingSpecialMapextending | RecipeSerializerCraftingSpecialShielddecoration | RecipeSerializerCraftingTransmute | RecipeSerializerSmelting | RecipeSerializerSmithingTransform | RecipeSerializerSmithingTrim | RecipeSerializerSmoking | RecipeSerializerStonecutting | RecipeSerializerFallbackType);
...
export type SymbolRecipeSerializer<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? RecipeSerializerDispatcherMap : CASE extends 'keys' ? RecipeSerializerKeys : CASE extends '%fallback' ? RecipeSerializerFallback : CASE extends '%unknown' ? RecipeSerializerFallbackType : never;
export {};
