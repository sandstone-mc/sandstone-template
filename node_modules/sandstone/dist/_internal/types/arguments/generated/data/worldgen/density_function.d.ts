...
type DensityFunctionFallback = (DensityFunctionAbs | DensityFunctionAdd | DensityFunctionBlendDensity | DensityFunctionCache2d | DensityFunctionCacheAllInCell | DensityFunctionCacheOnce | DensityFunctionClamp | DensityFunctionConstant | DensityFunctionCube | DensityFunctionFindTopSurface | DensityFunctionFlatCache | DensityFunctionHalfNegative | DensityFunctionInterpolated | DensityFunctionIntervalSelect | DensityFunctionInvert | DensityFunctionMax | DensityFunctionMin | DensityFunctionMul | DensityFunctionNoise | DensityFunctionOldBlendedNoise | DensityFunctionQuarterNegative | DensityFunctionRangeChoice | DensityFunctionShift | DensityFunctionShiftA | DensityFunctionShiftB | DensityFunctionShiftedNoise | DensityFunctionSlide | DensityFunctionSpline | DensityFunctionSquare | DensityFunctionSqueeze | DensityFunctionWeirdScaledSampler | DensityFunctionYClampedGradient | DensityFunctionFallbackType);
...
export type SymbolDensityFunction<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? DensityFunctionDispatcherMap : CASE extends 'keys' ? DensityFunctionKeys : CASE extends '%fallback' ? DensityFunctionFallback : CASE extends '%unknown' ? DensityFunctionFallbackType : never;
export {};
