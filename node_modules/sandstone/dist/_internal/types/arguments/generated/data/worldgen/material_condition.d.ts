...
export type BiomeCondition = {
    biome_is: (Array<Registry['minecraft:worldgen/biome']> | (Registry['minecraft:worldgen/biome'] | `#${Registry['minecraft:tag/worldgen/biome']}` | TagClass<'worldgen/biome'>));
};
...
type MaterialConditionFallback = (MaterialConditionBiome | MaterialConditionNoiseThreshold | MaterialConditionNot | MaterialConditionStoneDepth | MaterialConditionVerticalGradient | MaterialConditionWater | MaterialConditionYAbove);
...
export type SymbolMaterialCondition<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? MaterialConditionDispatcherMap : CASE extends 'keys' ? MaterialConditionKeys : CASE extends '%fallback' ? MaterialConditionFallback : never;
export {};
//# sourceMappingURL=material_condition.d.ts.map