import type { NoiseParameters } from '../dimension/biome_source.js';
import type { RuleBasedBlockStateProvider } from '../feature.js';
import type { IntProvider } from '../../worldgen.js';
import type { Registry } from '../../../registry.js';
import type { BlockState } from '../../../util/block_state.js';
import type { InclusiveRange, NonEmptyWeightedList } from '../../../util.js';
...
type BlockStateProviderFallback = (BlockStateProviderDualNoiseProvider | BlockStateProviderNoiseProvider | BlockStateProviderNoiseThresholdProvider | BlockStateProviderRandomizedIntStateProvider | BlockStateProviderRotatedBlockProvider | BlockStateProviderRuleBasedStateProvider | BlockStateProviderSimpleStateProvider | BlockStateProviderWeightedStateProvider);
...
export type SymbolBlockStateProvider<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? BlockStateProviderDispatcherMap : CASE extends 'keys' ? BlockStateProviderKeys : CASE extends '%fallback' ? BlockStateProviderFallback : never;
export {};
//# sourceMappingURL=block_state_provider.d.ts.map