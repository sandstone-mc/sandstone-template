...
import type { ItemModifier } from '../item_modifier.js';
import type { BlockEntityTarget, EntityTarget, ItemStackTarget, LootPoolEntry } from '../loot.js';
import type { LootCondition } from './condition.js';
import type { NumberProviderRef } from '../number_provider.js';
import type { IntRange, NbtProvider } from '../util.js';
...
import type { Filterable } from '../../util.js';
...
export type EnchantRandomly = ({
     ...
     */
    options?: ((Registry['minecraft:enchantment'] | `#${Registry['minecraft:tag/enchantment']}` | TagClass<'enchantment'> | EnchantmentClass) | Array<(Registry['minecraft:enchantment'] | EnchantmentClass)>);
    /**
...
export type LegacyExplorationMapDestination = ('pillager_outpost' | 'mineshaft' | 'manshion' | 'jungle_pyramid' | 'desert_pyramid' | 'igloo' | 'ruined_portal' | 'shipwreck' | 'swamp_hut' | 'stronghold' | 'monument' | 'ocean_ruin' | 'fortress' | 'endcity' | 'buried_treasure' | 'village' | 'nether_fossil' | 'bastion_remnent');
...
type ApplyBonusFormulaFallback = (ApplyBonusFormulaBinomialWithBonusCount | ApplyBonusFormulaOreDrops | ApplyBonusFormulaUniformBonusCount);
...
export type SymbolApplyBonusFormula<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? ApplyBonusFormulaDispatcherMap : CASE extends 'keys' ? ApplyBonusFormulaKeys : CASE extends '%fallback' ? ApplyBonusFormulaFallback : never;
...
type ListOperationFallback = (ListOperationAppend | ListOperationInsert | ListOperationReplaceAll | ListOperationReplaceSection);
