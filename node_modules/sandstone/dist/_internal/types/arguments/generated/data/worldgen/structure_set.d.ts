...
export type ConcentricRingsPlacement = {
    ...
    preferred_biomes: (Array<Registry['minecraft:worldgen/biome']> | (Registry['minecraft:worldgen/biome'] | `#${Registry['minecraft:tag/worldgen/biome']}` | TagClass<'worldgen/biome'>));
};
...
export type StructurePlacement = NonNullable<({
    ...
    } & (S extends keyof SymbolStructurePlacement ? SymbolStructurePlacement[S] : SymbolStructurePlacement<'%unknown'>));
...
type StructurePlacementFallback = (StructurePlacementConcentricRings | StructurePlacementRandomSpread | StructurePlacementFallbackType);
...
export type SymbolStructurePlacement<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? StructurePlacementDispatcherMap : CASE extends 'keys' ? StructurePlacementKeys : CASE extends '%fallback' ? StructurePlacementFallback : CASE extends '%unknown' ? StructurePlacementFallbackType : never;
export {};
//# sourceMappingURL=structure_set.d.ts.map