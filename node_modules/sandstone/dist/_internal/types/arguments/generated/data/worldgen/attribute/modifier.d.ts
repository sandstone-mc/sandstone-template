import type { SymbolEnvironmentAttributeArgbColorModifier, SymbolEnvironmentAttributeColorModifier } from '../../../dispatcher.js';
import type { NBTObject, RootNBT } from '../../../../nbt.js';
import type { NBTFloat } from '../../../../../../index.js';
...
export type ColorAttributeModifier = NonNullable<({
    [S in Extract<Extract<ColorModifierType, string>, string>]?: {
         ...
         */
        modifier: S;
        argument: (S extends undefined ? SymbolEnvironmentAttributeColorModifier<'%none'> : (S extends keyof SymbolEnvironmentAttributeColorModifier ? SymbolEnvironmentAttributeColorModifier[S] : SymbolEnvironmentAttributeColorModifier<'%unknown'>));
    };
...
export type FloatAttributeModifier<T extends NBTObject> = ({
    [S in Extract<Extract<FloatModifierType, string>, string>]?: {
         ...
         */
        modifier: S;
        argument: (S extends undefined ? SymbolEnvironmentAttributeFloatModifier<T, '%none'> : (S extends keyof SymbolEnvironmentAttributeFloatModifier<T> ? SymbolEnvironmentAttributeFloatModifier<T>[S] : SymbolEnvironmentAttributeFloatModifier<T, '%unknown'>));
    };
...
export type TranslucentColorAttributeModifier = NonNullable<({
    [S in Extract<Extract<ColorModifierType, string>, string>]?: {
         ...
         */
        modifier: S;
        argument: (S extends undefined ? SymbolEnvironmentAttributeArgbColorModifier<'%none'> : (S extends keyof SymbolEnvironmentAttributeArgbColorModifier ? SymbolEnvironmentAttributeArgbColorModifier[S] : RootNBT));
    };
}[Extract<ColorModifierType, string>])>;
...
type EnvironmentAttributeFloatModifierFallback<T extends NBTObject> = (EnvironmentAttributeFloatModifierAlphaBlend<T> | EnvironmentAttributeFloatModifierOverride<T> | EnvironmentAttributeFloatModifierFallbackType<T>);
...
export type SymbolEnvironmentAttributeFloatModifier<T extends NBTObject, CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? EnvironmentAttributeFloatModifierDispatcherMap<T> : CASE extends 'keys' ? EnvironmentAttributeFloatModifierKeys : CASE extends '%fallback' ? EnvironmentAttributeFloatModifierFallback<T> : CASE extends '%none' ? EnvironmentAttributeFloatModifierNoneType<T> : CASE extends '%unknown' ? EnvironmentAttributeFloatModifierFallbackType<T> : never;
export {};
