import type { SymbolMcdocCustomDynamicEventKeys } from '../../dispatcher.js';
...
type InputControlFallback = (InputControlBoolean | InputControlNumberRange | InputControlSingleOption | InputControlText);
...
export type SymbolInputControl<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? InputControlDispatcherMap : CASE extends 'keys' ? InputControlKeys : CASE extends '%fallback' ? InputControlFallback : never;
export {};
