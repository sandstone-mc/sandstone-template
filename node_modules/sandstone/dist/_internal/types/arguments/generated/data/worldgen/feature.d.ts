import type { CaveSurface, FloatProvider, IntProvider } from '../worldgen.js';
import type { BlockPredicate } from './feature/block_predicate.js';
import type { BlockStateProvider } from './feature/block_state_provider.js';
import type { ConfiguredDecorator } from './feature/decorator.js';
import type { PlacedFeatureListRef, PlacedFeatureRef } from './feature/placement.js';
import type { FallenTreeConfig, TreeConfig } from './feature/tree.js';
import type { ProcessorListRef, RuleTest } from './processor_list.js';
import type { Registry } from '../../registry.js';
import type { BlockState } from '../../util/block_state.js';
import type { Direction, VerticalDirection } from '../../util/direction.js';
import type { FluidState } from '../../util/fluid_state.js';
import type { Rotation, WeightedList } from '../../util.js';
import type { RootNBT } from '../../../nbt.js';
import type { NBTFloat, NBTInt, NBTList, StructureClass, TagClass } from '../../../../../index.js';
...
export type GeodeBlockSettings = {
     ...
     */
    cannot_replace: ((`#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | Array<Registry['minecraft:block']>);
    /**
     * When encountering an invalid block, feature placement is cancelled.
     */
    invalid_blocks: ((`#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | Array<Registry['minecraft:block']>);
};
...
export type LargeDripstoneConfig = {
    replaceable_blocks: (Array<Registry['minecraft:block']> | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>));
    /**
     * Value:
     * Range: 1..512
     */
...
export type MultifaceGrowthConfig = ({
    ...
    can_be_placed_on?: (Array<Registry['minecraft:block']> | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>));
});
...
export type RandomNeighborSpreadConfig = {
    block: BlockStateProvider;
    accepted_neighbors: ((Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | Array<Registry['minecraft:block']>);
...
export type RootSystemConfig = {
    ...
    root_replaceable: ((`#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | Array<Registry['minecraft:block']>);
...
export type SpringConfig = {
    ...
    valid_blocks: (Array<Registry['minecraft:block']> | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>));
};
...
export type VegetationPatchConfig = {
    ...
    replaceable: ((`#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>) | Array<Registry['minecraft:block']>);
...
export type SymbolBlockPlacer<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? BlockPlacerDispatcherMap : CASE extends 'keys' ? BlockPlacerKeys : CASE extends '%fallback' ? BlockPlacerFallback : never;
...
type FeatureConfigFallback = (FeatureConfigBamboo | FeatureConfigBasaltColumns | FeatureConfigBlockBlob | FeatureConfigBlockColumn | FeatureConfigBlockPile | FeatureConfigCoralClaw | FeatureConfigCoralTree | FeatureConfigDeltaFeature | FeatureConfigDisk | FeatureConfigDripstoneCluster | FeatureConfigEmeraldOre | FeatureConfigEndGateway | FeatureConfigEndSpike | FeatureConfigFallenTree | FeatureConfigFillLayer | FeatureConfigFlower | FeatureConfigFossil | FeatureConfigGeode | FeatureConfigGlowLichen | FeatureConfigHugeBrownMushroom | FeatureConfigHugeFungus | FeatureConfigHugeRedMushroom | FeatureConfigIcePatch | FeatureConfigIceberg | FeatureConfigLake | FeatureConfigLargeDripstone | FeatureConfigMultifaceGrowth | FeatureConfigNetherForestVegetation | FeatureConfigNetherrackReplaceBlobs | FeatureConfigNoBonemealFlower | FeatureConfigNoSurfaceOre | FeatureConfigOre | FeatureConfigPointedDripstone | FeatureConfigRandomBooleanSelector | FeatureConfigRandomPatch | FeatureConfigRandomSelector | FeatureConfigReplaceSingleBlock | FeatureConfigRootSystem | FeatureConfigScatteredOre | FeatureConfigSculkPatch | FeatureConfigSeaPickle | FeatureConfigSeagrass | FeatureConfigSequence | FeatureConfigSimpleBlock | FeatureConfigSimpleRandomSelector | FeatureConfigSpeleothem | FeatureConfigSpeleothemCluster | FeatureConfigSpike | FeatureConfigSpringFeature | FeatureConfigTemplate | FeatureConfigTree | FeatureConfigTwistingVines | FeatureConfigUnderwaterMagma | FeatureConfigVegetationPatch | FeatureConfigWaterloggedVegetationPatch | FeatureConfigWeightedRandomSelector);
...
export type SymbolFeatureConfig<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? FeatureConfigDispatcherMap : CASE extends 'keys' ? FeatureConfigKeys : CASE extends '%fallback' ? FeatureConfigFallback : never;
export {};
