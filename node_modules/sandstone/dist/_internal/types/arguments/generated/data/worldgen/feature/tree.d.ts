import type { BlockStateProvider } from './block_state_provider.js';
import type { IntProvider, UniformIntProvider } from '../../worldgen.js';
import type { Registry } from '../../../registry.js';
import type { Direction } from '../../../util/direction.js';
import type { RootNBT } from '../../../../nbt.js';
import type { NBTFloat, NBTInt, NBTList, TagClass } from '../../../../../../index.js';
...
export type MangroveRootPlacement = {
    ...
    can_grow_through: (Array<Registry['minecraft:block']> | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>));
    muddy_roots_in: (Array<Registry['minecraft:block']> | (Registry['minecraft:block'] | `#${Registry['minecraft:tag/block']}` | TagClass<'block'>));
...
export type SymbolFeatureSize<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? FeatureSizeDispatcherMap : CASE extends 'keys' ? FeatureSizeKeys : CASE extends '%fallback' ? FeatureSizeFallback : never;
...
type FoliagePlacerFallback = (FoliagePlacerBlobFoliagePlacer | FoliagePlacerBushFoliagePlacer | FoliagePlacerCherryFoliagePlacer | FoliagePlacerFancyFoliagePlacer | FoliagePlacerJungleFoliagePlacer | FoliagePlacerMegaPineFoliagePlacer | FoliagePlacerPineFoliagePlacer | FoliagePlacerRandomSpreadFoliagePlacer | FoliagePlacerSpruceFoliagePlacer);
...
export type SymbolFoliagePlacer<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? FoliagePlacerDispatcherMap : CASE extends 'keys' ? FoliagePlacerKeys : CASE extends '%fallback' ? FoliagePlacerFallback : never;
...
export type SymbolRootPlacer<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? RootPlacerDispatcherMap : CASE extends 'keys' ? RootPlacerKeys : CASE extends '%fallback' ? RootPlacerFallback : never;
...
type TreeDecoratorFallback = (TreeDecoratorAlterGround | TreeDecoratorAttachedToLeaves | TreeDecoratorAttachedToLogs | TreeDecoratorBeehive | TreeDecoratorCocoa | TreeDecoratorCreakingHeart | TreeDecoratorLeaveVine | TreeDecoratorPaleMoss | TreeDecoratorPlaceOnGround);
...
export type SymbolTreeDecorator<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? TreeDecoratorDispatcherMap : CASE extends 'keys' ? TreeDecoratorKeys : CASE extends '%fallback' ? TreeDecoratorFallback : never;
...
type TrunkPlacerFallback = (TrunkPlacerBendingTrunkPlacer | TrunkPlacerCherryTrunkPlacer | TrunkPlacerDarkOakTrunkPlacer | TrunkPlacerFancyTrunkPlacer | TrunkPlacerForkingTrunkPlacer | TrunkPlacerGiantTrunkPlacer | TrunkPlacerMegaJungleTrunkPlacer | TrunkPlacerStraightTrunkPlacer | TrunkPlacerUpwardsBranchingTrunkPlacer);
...
export type SymbolTrunkPlacer<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? TrunkPlacerDispatcherMap : CASE extends 'keys' ? TrunkPlacerKeys : CASE extends '%fallback' ? TrunkPlacerFallback : never;
export {};
