import type { DamageSourcePredicate, EntityPredicate, ItemPredicate, LocationPredicate } from '../advancement/predicate.js';
import type { LevelBasedValue } from '../enchantment/level_based_value.js';
import type { EntityTarget } from '../loot.js';
import type { NumberProviderRef } from '../number_provider.js';
import type { PredicateListRef, PredicateRef } from '../predicate.js';
import type { IntRange } from '../util.js';
import type { SymbolEnvironmentAttribute, SymbolMcdocBlockStates } from '../../dispatcher.js';
import type { Registry } from '../../registry.js';
import type { RootNBT } from '../../../nbt.js';
import type { EnchantmentClass, NBTFloat, NBTInt, NBTLong, ObjectiveClass, PredicateClass, WorldClockClass } from '../../../../../index.js';
export type AllOf = {
    /**
...
export type EnvironmentAttributeCheck = NonNullable<({
    [S in Extract<Extract<Registry['minecraft:environment_attribute'], string>, string>]?: {
        attribute: S;
        value: (S extends keyof SymbolEnvironmentAttribute ? SymbolEnvironmentAttribute[S] : SymbolEnvironmentAttribute<'%unknown'>);
    };
...
type LootConditionFallback = (LootConditionAllOf | LootConditionAnyOf | LootConditionBlockStateProperty | LootConditionDamageSourceProperties | LootConditionEnchantmentActiveCheck | LootConditionEntityProperties | LootConditionEntityScores | LootConditionEnvironmentAttributeCheck | LootConditionInverted | LootConditionKilledByPlayer | LootConditionLocationCheck | LootConditionMatchTool | LootConditionRandomChance | LootConditionRandomChanceWithEnchantedBonus | LootConditionReference | LootConditionTableBonus | LootConditionTimeCheck | LootConditionValueCheck | LootConditionWeatherCheck);
...
export type SymbolLootCondition<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? LootConditionDispatcherMap : CASE extends 'keys' ? LootConditionKeys : CASE extends '%fallback' ? LootConditionFallback : never;
export {};
