...
import type { ContainerComponents } from './loot/function.js';
import type { Registry } from '../registry.js';
import type { ENTITY_SLOTS } from '../../index.js';
import type { RootNBT } from '../../nbt.js';
import type { LiteralUnion, NBTInt } from '../../../../index.js';
...
type SlotSourceFallback = (SlotSourceContents | SlotSourceEmpty | SlotSourceFiltered | SlotSourceGroup | SlotSourceLimitSlots | SlotSourceSlotRange);
...
export type SymbolSlotSource<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? SlotSourceDispatcherMap : CASE extends 'keys' ? SlotSourceKeys : CASE extends '%fallback' ? SlotSourceFallback : never;
export {};
//# sourceMappingURL=slot_source.d.ts.map