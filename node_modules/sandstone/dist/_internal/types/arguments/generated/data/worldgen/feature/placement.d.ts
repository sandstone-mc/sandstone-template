import type { CarveStep, HeightmapType, HeightProvider, IntProvider } from '../../worldgen.js';
import type { BlockPredicate } from './block_predicate.js';
import type { ConfiguredFeatureRef } from '../feature.js';
import type { Registry } from '../../../registry.js';
import type { VerticalDirection } from '../../../util/direction.js';
...
export type PlacedFeatureListRef = (PlacedFeature | NBTList<PlacedFeature, {
    leftExclusive: false;
    min: 1;
}> | (Registry['minecraft:worldgen/placed_feature'] | `#${string}:${string}` | TagClass<'worldgen/placed_feature'>) | NBTList<Registry['minecraft:worldgen/placed_feature'], {
    leftExclusive: false;
    min: 1;
}>);
...
type PlacementModifierFallback = (PlacementModifierBlockPredicateFilter | PlacementModifierCount | PlacementModifierCountOnEveryLayer | PlacementModifierEnvironmentScan | PlacementModifierFixedPlacement | PlacementModifierHeightRange | PlacementModifierHeightmap | PlacementModifierNoiseBasedCount | PlacementModifierNoiseThresholdCount | PlacementModifierRandomOffset | PlacementModifierRarityFilter | PlacementModifierSurfaceRelativeThresholdFilter | PlacementModifierSurfaceWaterDepthFilter);
...
export type SymbolPlacementModifier<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? PlacementModifierDispatcherMap : CASE extends 'keys' ? PlacementModifierKeys : CASE extends '%fallback' ? PlacementModifierFallback : never;
export {};
