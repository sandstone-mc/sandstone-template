...
type DecoratorConfigFallback = (DecoratorConfigCarvingMask | DecoratorConfigCaveSurface | DecoratorConfigChance | DecoratorConfigCount | DecoratorConfigCountExtra | DecoratorConfigCountMultilayer | DecoratorConfigCountNoise | DecoratorConfigCountNoiseBiased | DecoratorConfigDarkOakTree | DecoratorConfigDecorated | DecoratorConfigEndGateway | DecoratorConfigFire | DecoratorConfigGlowstone | DecoratorConfigHeightmap | DecoratorConfigHeightmapSpreadDouble | DecoratorConfigIceberg | DecoratorConfigLavaLake | DecoratorConfigNope | DecoratorConfigRange | DecoratorConfigSpread32Above | DecoratorConfigSquare | DecoratorConfigWaterDepthThreshold);
...
export type SymbolDecoratorConfig<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? DecoratorConfigDispatcherMap : CASE extends 'keys' ? DecoratorConfigKeys : CASE extends '%fallback' ? DecoratorConfigFallback : never;
export {};
