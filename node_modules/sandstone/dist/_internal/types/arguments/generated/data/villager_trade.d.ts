...
import type { NumberProvider } from './number_provider.js';
import type { Predicate } from './predicate.js';
import type { Registry } from '../registry.js';
import type { ItemStackTemplate, TradeCost } from '../world/item.js';
import type { EnchantmentClass, TagClass } from '../../../../index.js';
export type VillagerTrade = {
     ...
     */
    double_trade_price_enchantments?: ((Registry['minecraft:enchantment'] | `#${Registry['minecraft:tag/enchantment']}` | TagClass<'enchantment'> | EnchantmentClass) | Array<(Registry['minecraft:enchantment'] | EnchantmentClass)>);
};
//# sourceMappingURL=villager_trade.d.ts.map