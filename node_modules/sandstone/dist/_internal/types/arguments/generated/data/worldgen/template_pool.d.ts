import type { PlacedFeatureRef } from './feature/placement.js';
import type { ProcessorListRef } from './processor_list.js';
import type { LiquidSettings } from './structure.js';
import type { Registry } from '../../registry.js';
import type { RootNBT } from '../../../nbt.js';
import type { NBTInt, StructureClass } from '../../../../../index.js';
...
type TemplatePoolElementFallback = (TemplatePoolElementFeaturePoolElement | TemplatePoolElementLegacySinglePoolElement | TemplatePoolElementListPoolElement | TemplatePoolElementSinglePoolElement);
...
export type SymbolTemplatePoolElement<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? TemplatePoolElementDispatcherMap : CASE extends 'keys' ? TemplatePoolElementKeys : CASE extends '%fallback' ? TemplatePoolElementFallback : never;
export {};
//# sourceMappingURL=template_pool.d.ts.map