...
import type { NBTFloat, NBTList } from '../../../../../index.js';
...
type LevelBasedValueFallback = (LevelBasedValueClamped | LevelBasedValueExponent | LevelBasedValueFraction | LevelBasedValueLevelsSquared | LevelBasedValueLinear | LevelBasedValueLookup);
...
export type SymbolLevelBasedValue<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? LevelBasedValueDispatcherMap : CASE extends 'keys' ? LevelBasedValueKeys : CASE extends '%fallback' ? LevelBasedValueFallback : never;
export {};
//# sourceMappingURL=level_based_value.d.ts.map