import type { SymbolDialogAction, SymbolMcdocCustomDynamicEventAdditions } from '../../dispatcher.js';
...
export type DynamicCustomAction = NonNullable<({
    [S in Extract<Extract<`${string}:${string}`, string>, string>]?: {
         ...
         */
        additions?: (S extends keyof SymbolMcdocCustomDynamicEventAdditions ? SymbolMcdocCustomDynamicEventAdditions[S] : SymbolMcdocCustomDynamicEventAdditions<'%unknown'>);
    };
