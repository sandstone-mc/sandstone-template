import type { AttributeTrackBase } from '../timeline.js';
import type { MoonPhase, SoundEventRef } from '../util.js';
import type { BooleanAttributeModifier, BooleanModifierType, ColorAttributeModifier, ColorModifierType, FloatAttributeModifier, FloatModifierType, ListModifier, ListModifierType, MergeableModifier, MergeableModifierType, OverrideModifier, TranslucentColorAttributeModifier } from './attribute/modifier.js';
import type { BiomeMusic, BiomeSoundAdditions, MoodSound } from './biome.js';
import type { SymbolEnvironmentAttributeArgbColorModifier, SymbolEnvironmentAttributeColorModifier, SymbolEnvironmentAttributeFloatModifier } from '../../dispatcher.js';
import type { Registry } from '../../registry.js';
import type { StringARGB, StringRGB } from '../../util/color.js';
import type { Particle } from '../../util/particle.js';
import type { Text } from '../../util/text.js';
import type { NBTObject, RootNBT } from '../../../nbt.js';
import type { NBTFloat, NBTInt, NBTList } from '../../../../../index.js';
    ...
    attribute_track: ({
        [S in Extract<Extract<ColorModifierType, string>, string>]?: (AttributeTrackBase & {
            ...
            keyframes: NBTList<{
                ...
                value: (S extends undefined ? SymbolEnvironmentAttributeArgbColorModifier<'%none'> : (S extends keyof SymbolEnvironmentAttributeArgbColorModifier ? SymbolEnvironmentAttributeArgbColorModifier[S] : RootNBT));
            }, {
                leftExclusive: false;
                min: 1;
            }>;
...
export type EnvironmentAttributeMap<K extends NBTObject> = ({
    [Key in Extract<K, string>]?: ((Key extends keyof SymbolEnvironmentAttribute ? ('value' extends keyof SymbolEnvironmentAttribute[Key] ? SymbolEnvironmentAttribute[Key]['value'] : SymbolEnvironmentAttribute<'%unknown'>) : SymbolEnvironmentAttribute<'%unknown'>) | (Key extends keyof SymbolEnvironmentAttribute ? ('modifier' extends keyof SymbolEnvironmentAttribute[Key] ? SymbolEnvironmentAttribute[Key]['modifier'] : SymbolEnvironmentAttribute<'%unknown'>) : SymbolEnvironmentAttribute<'%unknown'>));
});
    ...
    attribute_track: ({
        [S in Extract<Extract<FloatModifierType, string>, string>]?: (AttributeTrackBase & {
            ...
            keyframes: NBTList<{
                ...
                value: (S extends undefined ? SymbolEnvironmentAttributeFloatModifier<T, '%none'> : (S extends keyof SymbolEnvironmentAttributeFloatModifier<T> ? SymbolEnvironmentAttributeFloatModifier<T>[S] : SymbolEnvironmentAttributeFloatModifier<T, '%unknown'>));
            }, {
                leftExclusive: false;
                min: 1;
            }>;
...
export type NumericalEnvironmentAttribute = ('visual/cloud_height' | 'visual/fog_start_distance' | 'visual/moon_angle' | 'visual/star_angle' | 'visual/sun_angle' | 'visual/water_fog_start_distance' | 'visual/cloud_fog_end_distance' | 'visual/fog_end_distance' | 'visual/sky_fog_end_distance' | 'visual/water_fog_end_distance' | 'visual/sky_light_factor' | 'visual/star_brightness' | 'audio/music_volume' | 'gameplay/cat_waking_up_gift_chance' | 'gameplay/creature_world_gen_spawn_probability' | 'gameplay/surface_slime_spawn_chance' | 'gameplay/turtle_egg_hatch_chance' | 'gameplay/sky_light_level');
    ...
    attribute_track: ({
        [S in Extract<Extract<ColorModifierType, string>, string>]?: (AttributeTrackBase & {
            ...
            keyframes: NBTList<{
                ...
                value: (S extends undefined ? SymbolEnvironmentAttributeColorModifier<'%none'> : (S extends keyof SymbolEnvironmentAttributeColorModifier ? SymbolEnvironmentAttributeColorModifier[S] : SymbolEnvironmentAttributeColorModifier<'%unknown'>));
            }, {
                leftExclusive: false;
                min: 1;
            }>;
...
type EnvironmentAttributeFallback = (EnvironmentAttributeAudioAmbientSounds | EnvironmentAttributeAudioBackgroundMusic | EnvironmentAttributeAudioFireflyBushSounds | EnvironmentAttributeAudioMusicVolume | EnvironmentAttributeGameplayBabyVillagerActivity | EnvironmentAttributeGameplayBedRule | EnvironmentAttributeGameplayBeesStayInHive | EnvironmentAttributeGameplayCanPillagerPatrolSpawn | EnvironmentAttributeGameplayCanStartRaid | EnvironmentAttributeGameplayCatWakingUpGiftChance | EnvironmentAttributeGameplayCreakingActive | EnvironmentAttributeGameplayEyeblossomOpen | EnvironmentAttributeGameplayFastLava | EnvironmentAttributeGameplayIncreasedFireBurnout | EnvironmentAttributeGameplayMonstersBurn | EnvironmentAttributeGameplayNetherPortalSpawnsPiglin | EnvironmentAttributeGameplayPiglinsZombify | EnvironmentAttributeGameplayRespawnAnchorWorks | EnvironmentAttributeGameplaySkyLightLevel | EnvironmentAttributeGameplaySnowGolemMelts | EnvironmentAttributeGameplaySurfaceSlimeSpawnChance | EnvironmentAttributeGameplayTurtleEggHatchChance | EnvironmentAttributeGameplayVillagerActivity | EnvironmentAttributeGameplayWaterEvaporates | EnvironmentAttributeVisualAmbientLightColor | EnvironmentAttributeVisualAmbientParticles | EnvironmentAttributeVisualBlockLightTint | EnvironmentAttributeVisualCloudColor | EnvironmentAttributeVisualCloudFogEndDistance | EnvironmentAttributeVisualCloudHeight | EnvironmentAttributeVisualDefaultDripstoneParticle | EnvironmentAttributeVisualFogColor | EnvironmentAttributeVisualFogEndDistance | EnvironmentAttributeVisualFogStartDistance | EnvironmentAttributeVisualMoonAngle | EnvironmentAttributeVisualMoonPhase | EnvironmentAttributeVisualNightVisionColor | EnvironmentAttributeVisualSkyColor | EnvironmentAttributeVisualSkyFogEndDistance | EnvironmentAttributeVisualSkyLightColor | EnvironmentAttributeVisualSkyLightFactor | EnvironmentAttributeVisualStarAngle | EnvironmentAttributeVisualStarBrightness | EnvironmentAttributeVisualSunAngle | EnvironmentAttributeVisualSunriseSunsetColor | EnvironmentAttributeVisualWaterFogColor | EnvironmentAttributeVisualWaterFogEndDistance | EnvironmentAttributeVisualWaterFogStartDistance | EnvironmentAttributeFallbackType);
...
export type SymbolEnvironmentAttribute<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? EnvironmentAttributeDispatcherMap : CASE extends 'keys' ? EnvironmentAttributeKeys : CASE extends '%fallback' ? EnvironmentAttributeFallback : CASE extends '%unknown' ? EnvironmentAttributeFallbackType : never;
export {};
