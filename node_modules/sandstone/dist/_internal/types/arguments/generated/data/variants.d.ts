...
import type { NBTDouble, NBTInt, TagClass } from '../../../../index.js';
...
export type SymbolSpawnCondition<CASE extends 'map' | 'keys' | '%fallback' | '%none' | '%unknown' = 'map'> = CASE extends 'map' ? SpawnConditionDispatcherMap : CASE extends 'keys' ? SpawnConditionKeys : CASE extends '%fallback' ? SpawnConditionFallback : never;
export {};
